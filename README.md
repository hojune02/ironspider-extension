...
Replication and extension study of *Compromising Industrial Processes using Web-Based Programmable Logic Controller Malware* (NDSS 2024)
...
The list below contains an overview on my replication and extension study. The bold text indicates my own extension on the original paper's research. Please refer to `notes/labnotebook.md` for more detail.
