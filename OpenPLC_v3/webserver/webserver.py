...
from ironspider_detector import detector as ironspider_detector
...
def before_request():
    ...
    ironspider_detector.on_request(
        flask.request.path,
...
@app.route('/ironspider-alerts')
def ironspider_alerts():
    """Detection dashboard — returns all behavioral anomaly alerts as JSON."""
    return flask.jsonify({
        'summary': ironspider_detector.get_summary(),
        'alerts':  ironspider_detector.get_alerts()
    })
