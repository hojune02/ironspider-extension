...
\begin{enumerate}
  \item \textbf{Count-based (rejected):} This strived to count all GET requests to \texttt{/static/malware.js}. Not only did it has the name of the malware hardcoded in the detector, but also it falsely categorised the monitoring page's \texttt{<script src>} load as malicious.
...
This study focused on the evaluation of Tier~1, since it was considered to be the primary indicator of WB PLC malware. Tier~2 (write rate) and Tier~3 (read-write latency) were implemented and observed to 
